![Angular-Base logo](./app/app.assets/img/angular-base-logo.png)
...
We also use a number of node.js tools to initialize and test Angular-base. You must have node.js and
...
```bash
git clone --depth=1 https://github.com/angular/angular-base.git <your-project-name>
```
